...
public class Account {
     ...
     */
    public void viewInteractions(LinkedList<Account> users, String username){
        if(loggedIn == true){
     ...
     */
    public void addComment(LinkedList<Account> users, int postId,int interactionId,String comment){
        if(loggedIn == true){
    ...
    public void unComment(LinkedList<Account> users, int postId,int interactionId){
        int flag = 0;
        if(loggedIn == true){
            int searchUser = findUserPost(users, postId);
            if(searchUser != -1){
     ...
     */
    public void addLike(LinkedList<Account> users, int postId,int interactionId){
        int flag = 0;
        if(loggedIn == true){
            int searchUser = findUserPost(users, postId);
            if(searchUser != -1){
    ...
    public void removeLike(LinkedList<Account> users, int postId,int interactionId){
        int flag = 0;
        if(loggedIn == true){
            int searchUser = findUserPost(users, postId);
            if(searchUser != -1){
     ...
     */
    public void sendMessage(LinkedList<Account> users, int senderId, int receiverId, String content, int messageId){
        int checkFollow = 0;
        if(loggedIn == true){
     ...
     * @param users is array of accounts.
     */
    public void checkInbox(LinkedList<Account> users){
        int messageNumber = 0;
        if(loggedIn == true){
     ...
     */
    public void checkOutbox(LinkedList<Account> users){
        int messageNumber = 0;
        if(loggedIn == true){
     ...
     */
    public void follow(LinkedList<Account> users, String username){
        int checkFollow = 0;
        if(loggedIn == true){
    ...
    public void unfollow(LinkedList<Account> users, String username){
     ...
     */
    private void getFollower(LinkedList<Account> users,String username){
        int searchUser = findUser(users, username);
    ...
    private void removeFollower(LinkedList<Account> users,String username){
     ...
     */
    public void printProfile(LinkedList<Account> users, String username)
    {   
     ...
     */
    public void printPosts(LinkedList<Account> users, String username){
        int searchUser = findUser(users, username);
        if(loggedIn == true){
            if(searchUser != -1){
     ...
     */
    public void blockUser(LinkedList<Account> users, String blockUser){
        if(loggedIn == true){
    ...
    public void unBlockUser(LinkedList<Account> users, String unBlock){
        if(loggedIn == true){
            int searchUser = findUser(users, this.username);
     ...
     */
    private int findUser(LinkedList<Account> users, String username){
        int searchUser=-1;
     ...
     */
    private int findUserPost(LinkedList<Account> users, int postid){
        int searchUser=-1;
        for(int i=0;i<users.size();i++){
     ...
     */
    private int findUserAccountId(LinkedList<Account> users, int accountid){
        int searchUser=-1;
        for(int i=0;i<users.size();i++){
