...
public class Account {
     ...
     */
    public void viewInteractions(LDLinkedList<Account> users, String username){
        if(loggedIn == true){
     ...
     */
    public void addComment(LDLinkedList<Account> users, int postId,int interactionId,String comment){
        if(loggedIn == true){
    ...
    public void unComment(LDLinkedList<Account> users, int postId,int interactionId){
        int flag = 0;
        if(loggedIn == true){
            int searchUser = findUserPost(users, postId);
            if(searchUser != -1){
                ...
                for(int i = 0; i<users.get(searchUser).posts.size();i++){
                    if(users.get(searchUser).posts.get(i).postId == postId){
                        for(int j = 0;j < users.get(searchUser).posts.get(i).comments.size(); j++){
                            if(users.get(searchUser).posts.get(i).comments.get(j) != null && users.get(searchUser).posts.get(i).comments.get(j).username == username){
                                flag = 1;
     ...
     */
    public void addLike(LDLinkedList<Account> users, int postId,int interactionId){
        int flag = 0;
        if(loggedIn == true){
            int searchUser = findUserPost(users, postId);
            if(searchUser != -1){
                ...
                for(int i = 0; i<users.get(searchUser).posts.size();i++){
                    if(users.get(searchUser).posts.get(i).postId == postId){
                        for(int x = 0;x < users.get(searchUser).posts.get(i).likes.size(); x++){
                            if(users.get(searchUser).posts.get(i).likes.checkLazily(x)!=true){
                            if(users.get(searchUser).posts.get(i).likes.get(x) != null && users.get(searchUser).posts.get(i).likes.get(x).username == this.username){
                                flag=1;
    ...
    public void removeLike(LDLinkedList<Account> users, int postId,int interactionId){
        int flag = 0;
        if(loggedIn == true){
            int searchUser = findUserPost(users, postId);
            if(searchUser != -1){
                ...
                for(int i = 0; i<users.get(searchUser).posts.size();i++){
                    if(users.get(searchUser).posts.get(i).postId == postId){
                        for(int x = 0;x < users.get(searchUser).posts.get(i).likes.size(); x++){
                            if(users.get(searchUser).posts.get(i).likes.get(x) != null && users.get(searchUser).posts.get(i).likes.get(x).username.equals(this.username)){
                                flag=1;
     ...
     */
    public void sendMessage(LDLinkedList<Account> users, int senderId, int receiverId, String content, int messageId){
        int checkFollow = 0;
        if(loggedIn == true){
            int searchUser = findUserAccountId(users, receiverId);
            for(int i = 0 ;i < following.size(); i++){
                if(following.get(i)!=null && users.get(searchUser).username == following.get(i).username) checkFollow = 1;
            }
     ...
     * @param users is array of accounts.
     */
    public void checkInbox(LDLinkedList<Account> users){
        int messageNumber = 0;
        if(loggedIn == true){
     ...
     */
    public void checkOutbox(LDLinkedList<Account> users){
        int messageNumber = 0;
        if(loggedIn == true){
     ...
     */
    public void follow(LDLinkedList<Account> users, String username){
        int checkFollow = 0;
        if(loggedIn == true){
            if(username == this.username){System.out.println("You can not follow yourself!\n");}
                ...
                int searchUser = findUser(users, username);
                for(int i = 0; i < following.size(); i++){
                    if(following.get(i)!=null &&    following.get(i).username == users.get(searchUser).username) checkFollow = 1;
                }
                if(searchUser != -1){
    ...
    public void unfollow(LDLinkedList<Account> users, String username){
        ...
        if(loggedIn == true){
            if(username == this.username){System.out.println("You can not unfollow yourself!\n");}
                ...
                int searchUser = findUser(users, username);
                for(int i = 0; i < following.size(); i++){
                    if(following.get(i)!=null && following.get(i).username == users.get(searchUser).username) {checkFollow = 1; index = i;}
                }
                if(searchUser != -1){
     ...
     */
    private void getFollower(LDLinkedList<Account> users,String username){
        int searchUser = findUser(users, username);
    ...
    private void removeFollower(LDLinkedList<Account> users,String username){
        for(int i = 0;i < followers.size(); i++){
            if(followers.get(i)!=null && followers.get(i).username == username) followers.remove(i);
        }
    }
    /**
     ...
     */
    public void printProfile(LDLinkedList<Account> users, String username)
    {   
        int followingCounter=0,followerCounter=0;
        if(checkBlock(username) == 0){
            ...
            if(searchUser != -1){
                ...
                for(int i = 0;i<users.get(searchUser).following.size();i++){
                    if(users.get(searchUser).following.get(i)!= null && users.get(searchUser).following.checkLazily(i)!=true) followingCounter++;
                }
                for(int i = 0;i<users.get(searchUser).followers.size();i++){
                    if(users.get(searchUser).followers.get(i)!= null && users.get(searchUser).followers.checkLazily(i)!=true) followerCounter++;
                }
                if(followingCounter == 0 && followerCounter == 0){ System.out.println(users.get(searchUser).username + " is following 0 account and has 0 follower(s).");}
                else{System.out.println(users.get(searchUser).username + " is following " + followingCounter + " account(s) and has " + followerCounter + " follower.");}

                if(followerCounter != 0){
                    System.out.print("The followers of " + users.get(searchUser).username + " are: ");
                    for(int i = 0; i<users.get(searchUser).followers.size();i++){
                        if(users.get(searchUser).followers.get(i)!= null) System.out.print(users.get(searchUser).followers.get(i).username + ", ");
                    }
                    System.out.print("\n");
                }
                if(followingCounter != 0){
                    ...
                    for(int i = 0; i<users.get(searchUser).following.size();i++){
                        ...
                        if(users.get(searchUser).following.get(i)!= null) System.out.print(users.get(searchUser).following.get(i).username + ", ");
                    }
                    System.out.print("\n");
                }
     ...
     */
    public void printPosts(LDLinkedList<Account> users, String username){
        int searchUser = findUser(users, username);
        if(loggedIn == true){
            if(searchUser != -1){
     ...
     */
    public void blockUser(LDLinkedList<Account> users, String blockUser){
        if(loggedIn == true){
            ...
            if(searchUser != -1 && blocker != -1){
                ...
                for(int i = 0;i<followers.size();i++){
                    if(followers.get(i) != null && followers.get(i).username == blockUser) removeFollower(users, blockUser);
                }
            }else{System.out.println("User not found!!!\n");}
        }else{System.out.println("Current account is not '" + this.username + "'s account!!!\n");}
    }
    public void unBlockUser(LDLinkedList<Account> users, String unBlock){
        if(loggedIn == true){
            int searchUser = findUser(users, this.username);
     ...
     */
    private int findUser(LDLinkedList<Account> users, String username){
        int searchUser=-1;
     ...
     */
    private int findUserPost(LDLinkedList<Account> users, int postid){
        int searchUser=-1;
        for(int i=0;i<users.size();i++){
     ...
     */
    private int findUserAccountId(LDLinkedList<Account> users, int accountid){
        int searchUser=-1;
        for(int i=0;i<users.size();i++){
    ...
    private int checkBlock(String username){
        ...
        for(int i = 0; i < blocked.size(); i++){
            if(blocked.get(i) != null && blocked.get(i).username == username){
                x = 1;
            }
        }
        return x;
